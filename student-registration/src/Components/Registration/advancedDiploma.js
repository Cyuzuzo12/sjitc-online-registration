...
{/* =========================================document================== */}
               ...
               <div className="row">
                  ...
                  <div className="form-row p-2">
                    ...
                    <FileUpload filename={ (filename)=> this.storeResultSlip(filename) }/>
                    <hr/>
                    </div>

                    <div className="col">
                    <h6 className="purple">ID card or Passport</h6>
                    <FileUpload filename={ (filename)=> this.storeID(filename) }/>
                    <hr/>
                    </div>
                  </div>
                  <div className="form-row p-2">
                  <div className="col">
                    ...
                    <FileUpload filename={ (filename)=> this.storeReport1(filename) }/>
                    <FileUpload filename={ (filename)=> this.storeReport2(filename) }/>
                    <FileUpload filename={ (filename)=> this.storeReport3(filename) }/>
                    <hr/>
                    </div>
                    <div className="col">
                    <h6 className="purple">Bank Slip for registration payment</h6>
                    <FileUpload filename={ (filename)=> this.storeBankSlip(filename) }/>
